...
<body>
    ...
    <main class="main container-2">
        ...
        <section class="about about-box">
            <h1>Работа с нами</h1>

            <img src="img/handsh.png" alt="Рукопожатие">

            <p>
                Мы не берём любые заказы. Мы за точечные и масштабные цифровые решения.<br><br>
                ...
                • где клиент — партнёр, а не просто заказчик<br><br>
                ...
                5. Запуск, поддержка, масштаб<br><br>
            </p>
        </section>
    </main>
